...
{html_options id='list_type_advanced' name='list_type_advanced[]' options=$fields.list_type_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.list_type_advanced.value}
   	   	</td>
